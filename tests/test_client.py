...
def with_latest_version(mocker, prepare_server):
    ...
    mock_urlretrieve.return_value = [str(server_path.joinpath("repo_demo", "latest.zip")), dict()]
...
def test_checkout_version_success(mocker, with_latest_version):
    ...
    server_update_zip = str(server_path.joinpath("repo_demo", "v2", ".delta_to", "v1.zip"))
...
def test_checkout_version_twice_success(mocker, with_latest_version):
    ...
    server_update_zip = str(server_path.joinpath("repo_demo", "v1", ".delta_to", "v2.zip"))
